...
btnPromediar.addEventListener(`click`, ()=>{
    ...
    function promedioPerfecto(){
        ...
        <p>El ultimo alumno ingresado es: <span class="n-alumno">${ultimoAlumno}</span></p>
        <p>El promedio de '${ultimaMateria}' es de: <span class="aprob">${promedioTotal.toFixed(1)}</span></p>
        <p><span class="aprob">APROBADO</span> con promedio perfecto.</p>
        `
    ...
    function aprobado(){
        ...
        newElement.classList.add(`ultimo-ingresado`)
        newElement.innerHTML = `
        <p>El ultimo alumno ingresado es: <span class="n-alumno"><b>${ultimoAlumno}</b></span></p>
        <p>El promedio de '${ultimaMateria}' es de: <span class="aprob">${promedioTotal.toFixed(1)}</span></p>
        <p><span class="aprob">APROBADO.</span></p>
        `
        resultContainer.appendChild(newElement)
        setTimeout(function(){
            document.querySelector(".ultimo-ingresado").remove();
    ...
    function desaprobado(){
        ...
        newElement.innerHTML = `
        <p>El ultimo alumno ingresado es: <span class="n-alumno">${ultimoAlumno}</span></p>
        <p>El promedio de '${ultimaMateria}' es de: <span class="desaprob">${promedioTotal.toFixed(1)}</span></p>
        <p><span class="desaprob">DESAPROBADO.</span></p>
        `
        resultContainer.appendChild(newElement)
        setTimeout(function(){
            document.querySelector(".ultimo-ingresado").remove();
